...
- [3. 功能](#3-功能)
    ...
    - [3.6. 战场](#36-战场)
        ...
        - [3.6.3. 战绩](#363-战绩)
    - [3.7. 设置](#37-设置)
        - [3.7.1. supermaster](#371-supermaster)
        - [3.7.2. master](#372-master)
        - [3.7.3. 序列战争开](#373-序列战争开)
        - [3.7.4. 序列战争关](#374-序列战争关)
        - [3.7.5. 货币映射](#375-货币映射)
        - [3.7.6. 查看映射](#376-查看映射)
        - [3.7.7. 货币升级](#377-货币升级)
        - [3.7.8. 货币降级](#378-货币降级)
...
红包: 你现在可以给好友发金镑红包了，格式为：红包;金额;对方QQ号 
```
...
你现在可以给好友发金镑红包了，格式为：红包;金额;对方QQ号 

序列7以下不可发红包，序列7以上有金额限制。单次最大金额=100*2^n，其中n值取0~9。
...
bank可指定某个人的存款基准天数向前或向后便宜。例如`GM;bank;-1;67939461`
