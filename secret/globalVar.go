...
var secretInfo = [...]SecretInfo{
	...
	{SecretName: "死神", SecretLevelName: [10]string{"收尸人", "掘墓人", "通灵者", "死灵导师", "看门人", "不死者", "摆渡人", "死亡执政官", "苍白皇帝", "死神"}},
	{SecretName: "战神", SecretLevelName: [10]string{"战士", "格斗家", "武器大师", "黎明骑士", "守护者", "猎魔人", "银骑士", "未知", "神明之手", "黄昏巨人"}},
	{SecretName: "暗", SecretLevelName: [10]string{"秘祈人", "倾听者", "隐修士", "蔷薇主教", "牧羊人", "黑骑士", "三首圣堂", "未知", "暗天使", "倒吊人"}},
	...
	{SecretName: "智慧", SecretLevelName: [10]string{"阅读者", "推理学员", "侦探", "博学者", "秘术导师", "预言家", "未知", "未知", "全知之眼", "白塔"}},
	{SecretName: "太阳", SecretLevelName: [10]string{"歌颂者", "祈光人", "太阳神官", "公证人", "光之祭司", "无暗者", "正义导师", "逐光者", "纯白天使", "太阳"}},
	{SecretName: "异种", SecretLevelName: [10]string{"囚犯", "疯子", "狼人", "活尸", "怨灵", "木偶", "沉默门徒", "古代邪物", "神孽", "被缚者"}},
	{SecretName: "深渊", SecretLevelName: [10]string{"罪犯", "冷血者", "连环杀手", "恶魔", "欲望使徒", "魔鬼", "呓语者", "未知", "污秽君王", "深渊"}},
	{SecretName: "秘密", SecretLevelName: [10]string{"窥秘人", "格斗教授", "巫师", "卷轴教授", "星象师", "神秘学者", "预言大师", "贤者", "知识皇帝", "隐者"}},
	...
	{SecretName: "门", SecretLevelName: [10]string{"学徒", "戏法大师", "占星人", "记录官", "旅行家", "秘法师", "漫游者", "旅法师", "星之匙", "门"}},
	{SecretName: "时间", SecretLevelName: [10]string{"偷盗者", "诈骗师", "解密学者", "盗火人", "窃梦家", "寄生者", "欺瞒导师", "命运木马", "时之虫", "错误"}},
	{SecretName: "大地", SecretLevelName: [10]string{"耕种者", "医师", "丰收祭司", "生物学家", "德鲁伊", "古代炼金师", "抬棺人", "荒芜主母", "自然行者", "母亲"}},
	{SecretName: "月亮", SecretLevelName: [10]string{"药师", "驯兽师", "吸血鬼", "魔药教授", "深红学者", "巫王", "召唤大师", "创生者", "美神", "月亮"}},
...
var adventureEvents = [7]AdventureEvent{
	...
	AdventureEvent{Type: 5, Probability: 15, Messages: []string{
		"在东拜朗的一处森林内捡到了一片富含灵力的羽毛，专卖后得到了丰厚的报酬。",
	...
	AdventureEvent{Type: 6, Probability: 15, Messages: []string{
		...
		"参加了X先生的非凡聚会，结果X先生被最强冒险家格尔曼·罗切斯袭击。意外之中你幸运的没有受伤，还捡到了富含灵力的材料。",
		"你到廷根旅游，有幸得到了阿兹克男爵的款待。",
		"你遇到了危险，在咏念七神尊名都没有效果后你冒死咏念了愚者的尊名！灰白的雾气中，一个火焰羽翼的天使拥抱了你。你恢复了灵力，并且消灭了危险。",
	...
	AdventureEvent{Type: 7, Probability: 35, Messages: []string{
		...
		"灵力直觉忽然预警！你在自己家躲了一整天没敢出门，完全不知道自己究竟躲过了什么。不过在这个世界里，无知反而意味着安全。",
...
var menus = Menu{
	...
	[]Menu{
		...
		{3, "教会", "回复 教会 可显示与教会相关的指令。", "教会支持的技能包括：幸运光环，精力充沛，灵力协调。", []Menu{
		...
		{4, "商店", "回复 商店 可查看神秘黑市的商品清单。", "欢迎光临星火之潮贝克兰德分店，请在浏览商品时，戴好您的斗篷和面具（找到想要购买的商品后，只需要回复购买加商品名称即可，如：购买探险卷轴）", []Menu{
			...
			{42, "灵力药剂", "（70金榜）不明物质酿造的灵力药剂，据说口感极差。", "", nil},
			{43, "至高权杖", "（1000金镑）这是成立非凡者组织或教会必不可少的证明物。", "", nil},
			{44, "灵力材料", "（50金榜）随机得到1份灵力材料，可用于发动非凡仪式。（私聊时请说灵力材料一份，别问我为什么，我不知道……）", "", nil},
			{45, "红剧场门票", "（100金镑40灵力）听说很多非凡者看完表演都升级了。", "", nil},
		...
		{5, "生活", "回复 生活 可查看生活菜单。", "", []Menu{
			...
			{52, "地窖", "可将金镑存入生出小金镑。指令格式为：地窖;埋入;3500 地窖;探测 地窖;挖出;3500", "", nil},
			{53, "工作", "可选择一份工作获得稳定收益。回复工作查询可用工种。指令格式为：工作;女装直播 工作;停止（每日灵力-20，金镑+100）", "", nil},
			{54, "钓鱼", "可在风暴之海进行垂钓。灵力-5。", "", nil},
			{55, "许愿", "在广场喷水池投币许愿，极小概率幸运事件。金镑-2，0.2%的几率得女神垂青获得1000金镑。", "", nil},
			{56, "副本", "可随机开启一个文字游戏副本，建议在私聊下进行。", "", nil},
			{57, "竞赛", "回复竞赛可查看竞赛菜单，竞赛目前包含两种，速算和学识。", "", []Menu{
				{571, "速算", "你朋友请你替他去参加知识教会举办的有奖速算竞赛，他说考过了奖金全归你，考不过奖金归他。", "", nil},
				{572, "学识", "可随机开启一个知识教会发放的答题卷轴，答对有奖，打错无惩罚，连胜次数计入战场结算。消耗5灵力。", "", nil},
			}},
			{58, "紫包", "你现在可以给好友发金镑紫菜包饭了，格式为：紫包;金额;对方QQ号", "", nil},
		}},
		...
		{9, "宠物店", "回复 宠物店 可查看宠物相关的菜单，每个人只可驯养1位宠物伙伴。", "欢迎光临蘑菇屋宠物店~再这里你可以享受到贵宾级的服务。", []Menu{
			{91, "宠物状态", "查询宠物状态、属性、技能等信息。", "", nil},
			{92, "宠物改名", "可修改宠物昵称，为自己的宠物起一个响亮的名字吧！（每次100金镑）。格式为：宠物改名;新昵称", "", nil},
			{93, "宠物货架", "每日上新的可直接购买的宠物列表在这里查看。", "", nil},
			{94, "宠物领养", "在宠物货架上看到心仪的宠物后，可以申请领养。格式为：宠物领养;宠物名", "", nil},
			{95, "灵界法阵", "借用店内的灵力法阵，你可以沟通灵界，召唤奇妙的灵界宠物。请提前准备好灵力材料，每次消耗100金镑，20灵力。", "", nil},
			{96, "宠物晋级", "当你的宠物满足晋级标准时，你可以消耗经验和金镑为其晋级。", "", nil},
			{97, "宠物放生", "释放你的宠物回归大自然，它会将私房钱送给你作为感谢。", "", nil},
			{98, "宠物融合", "宠物和你融为一体，它将变成你的经验（吃掉了，80%转化率）。", "", nil},
			{99, "宠物历练", "强大的宠物少不了探险的历练。宠物出门探险，当宠物生命降为1时进入濒死状态，只能等待召回，若3天不召回，则死亡。", "", nil},
			{100, "宠物召回", "召唤你的宝贝宠物回家，以查看探险日志和收益。", "", nil},
			{101, "宠物美妆", "增加宠物颜值，颜值越高被投喂的几率越大。(500金镑/次）", "", nil},
		}},
	},
}
...
//后面3个数值分别是消耗的灵力，增加的金钱，增加的经验, 持续时间默认0
var workList = []Work{
...
var version = &Version{"序列战争", "v3.3.7", "2020-06-11"}
