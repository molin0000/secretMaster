...
var menus = Menu{
	...
	[]Menu{
		...
		{9, "宠物店", "回复 宠物店 可查看宠物相关的菜单，每个人只可驯养1位宠物伙伴。", "欢迎光临蘑菇屋宠物店~再这里你可以享受到贵宾级的服务。", []Menu{
			...
			{96, "宠物放生", "释放你的宠物回归大自然，它会将私房钱送给你作为感谢。", "", nil},
			{97, "宠物融合", "宠物和你融为一体，它将变成你的经验（吃掉了）。", "", nil},
			{98, "宠物探险", "强大的宠物少不了探险的历练。宠物出门探险，当宠物生命降为1时进入濒死状态，只能等待召回，若3天不召回，则死亡。", "", nil},
			{99, "宠物召回", "召唤你的宝贝宠物回家，以查看探险日志和收益。", "", nil},
			{100, "宠物美妆", "增加宠物颜值，颜值越高被投喂的几率越大。", "", nil},
		}},
	},
}
