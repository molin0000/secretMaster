...
var menus = Menu{
	...
	[]Menu{
		...
		{4, "商店", "回复 商店 可查看神秘黑市的商品清单。", "欢迎光临星火之潮贝克兰德分店，请在浏览商品时，戴好您的斗篷和面具（找到想要购买的商品后，只需要回复购买加商品名称即可，如：购买探险卷轴）", []Menu{
			...
			{45, "红剧场门票", "（100金镑40灵性）听说很多非凡者看完表演都升级了。", "", nil},
		...
		{5, "生活", "回复 生活 可查看生活菜单。", "", []Menu{
			...
			{57, "竞赛", "回复竞赛可查看竞赛菜单，竞赛目前包含两种，速算和学识。", "", []Menu{
				...
				{572, "学识", "可随机开启一个知识教会发放的答题卷轴，答对有奖，打错无惩罚，连胜次数计入战场结算。消耗5灵性。", "", nil},
			}},
			{58, "红包", "你现在可以给好友发金镑红包了，格式为：红包;金额;对方QQ号", "", nil},
		}},
		...
		{9, "宠物店", "回复 宠物店 可查看宠物相关的菜单，每个人只可驯养1位宠物伙伴。", "欢迎光临蘑菇屋宠物店~再这里你可以享受到贵宾级的服务。", []Menu{
			...
			{95, "灵界法阵", "借用店内的灵性法阵，你可以沟通灵界，召唤奇妙的灵界宠物。请提前准备好灵性材料，每次消耗100金镑，20灵性。", "", nil},
			{96, "宠物晋级", "当你的宠物满足晋级标准时，你可以消耗经验和金镑为其晋级。", "", nil},
			{97, "宠物放生", "释放你的宠物回归大自然，它会将私房钱送给你一半作为感谢。", "", nil},
			{98, "宠物融合", "宠物和你融为一体，它将变成你的经验（吃掉了，20%转化率）。", "", nil},
...
var version = &Version{"序列战争", "v3.1.1", "2020-03-24"}
